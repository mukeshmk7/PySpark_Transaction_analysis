...
tran = sc.textFile("/home/hadoop/pyspark/tran/transactions")
...
sc.parallelize(list_credit).saveAsTextFile("/home/hadoop/pyspark/tran/avg_credit")


list_cash=[]
list_cash.append("Average cash   ")
list_cash.append(avg_cash)
sc.parallelize(list_cash).saveAsTextFile("/home/hadoop/pyspark/tran/avg_cash")
...
list_2_countries={}
with open('/home/hadoop/pyspark/tran_2months','w') as f:
	for i in yearlytran:
...
sc.parallelize(least_city).saveAsTextFile("/home/hadoop/pyspark/tran/least_city")
...
sc.parallelize(top_2_product).saveAsTextFile("/home/hadoop/pyspark/tran/top_2_product")
